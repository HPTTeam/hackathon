...
class AW_Points_InvitationController extends Mage_Core_Controller_Front_Action
{
    ...
    public function createAccountAction()
    {
        ...
        $array_url = explode('?productid', $current_url);
        $end_current_url = end($array_url);
        if ($end_current_url != "") {

            $_SESSION['end_current_url'] = $end_current_url;

            $previous_product_url = Mage::getModel('catalog/product')->load($_SESSION['end_current_url'])->getProductUrl();

            $_SESSION['$previous_product_url'] = $previous_product_url;
            ?>
